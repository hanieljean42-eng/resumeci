...
function addFicheSeo(html, meta) {
  ...
  const head = `<head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"><title>${escapeHtml(title)}</title><meta name=\"description\" content=\"${escapeHtml(description)}\"><meta name=\"robots\" content=\"index, follow\"><link rel=\"canonical\" href=\"${url}\"><link rel=\"alternate\" hreflang=\"fr-CI\" href=\"${url}\"><link rel=\"alternate\" hreflang=\"x-default\" href=\"${url}\"><meta property=\"og:title\" content=\"${escapeHtml(title)}\"><meta property=\"og:description\" content=\"${escapeHtml(description)}\"><meta property=\"og:type\" content=\"article\"><meta property=\"og:url\" content=\"${url}\"><meta property=\"og:image\" content=\"${SITE_URL}/og-image.png\"><meta property=\"og:site_name\" content=\"ResumeCI\"><meta property=\"og:locale\" content=\"fr_CI\"><meta name=\"twitter:card\" content=\"summary_large_image\"><meta name=\"twitter:title\" content=\"${escapeHtml(title)}\"><meta name=\"twitter:description\" content=\"${escapeHtml(description)}\"><meta name=\"twitter:image\" content=\"${SITE_URL}/og-image.png\"><script type=\"application/ld+json\">${JSON.stringify(breadcrumb)}</script><script type=\"application/ld+json\">${JSON.stringify(article)}</script></head>`;
